   	 ...
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
                        ...
                        <view class="lable"
							...
							旅居史：</view>
                        <view class="text" :style='{"color":"#E57498","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.jiankangxinxiAddress}}</view>
                    </view>
			</view>
	...
	export default {
		...
		methods: {
			...
			async init() {
				...
				// 主图
				this.swiperList = this.detail.jiankangxinxiPhoto ? this.detail.jiankangxinxiPhoto.split(",") : [];
			},
